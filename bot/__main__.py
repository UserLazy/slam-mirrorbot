...
from .modules import authorize, list, cancel_mirror, mirror_status, mirror, clone, watch, shell, eval, torrent_search, delete, speedtest, usage, mediainfo, count, leech_settings, anime, weebify, stickers, animequotes, fun, nhentai, sitesearch, songs, telegraph, text, waifu
