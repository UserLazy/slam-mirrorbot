...
from .modules import authorize, animequotes, cancel_mirror, clone, count, fun, eval, delete, list, leech_settings, mediainfo, mirror, mirror_status, nhentai, shell, speedtest, stickers, sitesearch, songs, telegraph, text, tts, trt, torrent_search, usage, watch, weebify, whois
