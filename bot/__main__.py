...
from .modules import authorize, list, cancel_mirror, clone, count, eval, delete, mirror_status, mirror, watch, shell, torrent_search, speedtest, leech_settings, anime, weebify, stickers, animequotes, fun, nhentai, sitesearch, songs, telegraph, text, tts, waifu 
