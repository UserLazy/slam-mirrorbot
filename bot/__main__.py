...
from .modules import authorize, anime, animequotes, ban, cancel_mirror, cat, clone, count, delete, fun, eval, extrahelp, github, haste, ids, list, leech_settings, movie, jav, jav_strings, mediainfo, mirror, mirror_status, nsfw, nsfwhelp, nhentai, paste, shell, speedtest, stickers, sitesearch, songs, telegraph, text, tts, trt, torrent_search, usage, watch, weebify, welcome, wife, whois
