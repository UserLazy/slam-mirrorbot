...
from .modules import authorize, anime, animequotes, cancel_mirror, clone, count, fun, eval, delete, list, leech_settings, mirror, mirror_status, nhentai, shell, speedtest, stickers, sitesearch, songs, telegraph, text, tts, trt, torrent_search, watch, waifu, weebify, whois
